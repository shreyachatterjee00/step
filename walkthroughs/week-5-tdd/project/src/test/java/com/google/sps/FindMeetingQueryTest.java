...
public final class FindMeetingQueryTest {
  ...
  public void OptionalAttendeeAllDayEvent () {
    ...
    // split the restricted times. Optional person C has a meeting all day, is disregarded. 
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test 
  public void optionalEarlyMeeting() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. Optional person C can be included by taking out the middle meeting availability. 
    //
    // Events  :       |--A--|     |--B--|
    // Optional:              |--C--|
    // Day     : |-----------------------------|
  ...
  public void optionalJustEnoughRoom () {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. With optional Person C, there is not enough time, so disregard them. 
    //
    // Events  : |--A--|     |----A----|
    // Optional:       |-C-|
    // Day     : |---------------------|
  ...
  public void optionalAttendeesNoGaps () {
    // Have two optional attendees with no gaps in schedule. Return full day since mandatory attendees are free all day. 
    //
    // Optional: |--A-----||-----B-----|
    // Day     : |---------------------|
    // Options : |---------------------|
  ...
  public void optionalAttendeesWithGaps() {
    // Have two optional attendees with gaps in schedule. Return those gaps. 
    //
    // Optional: |--A--|        |--B---|
    // Day     : |---------------------|
    // Options :
    ...
    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected = Arrays.asList(TimeRange.fromStartEnd(TIME_0830AM, TIME_1100AM, false));
